...
make_poisson_reg_glm_offset <- function() {
  ...
  parsnip::set_dependency("poisson_reg", eng = "glm_offset", pkg = "stats",
                          mode = "regression")
  parsnip::set_dependency("poisson_reg", eng = "glm_offset", pkg = "poissonreg",
                          mode = "regression")
  parsnip::set_dependency("poisson_reg", eng = "glm_offset", pkg = "offsetreg",
                          mode = "regression")
...
#
#   parsnip::set_model_engine("poisson_reg", "regression", "glmnet_offset")
